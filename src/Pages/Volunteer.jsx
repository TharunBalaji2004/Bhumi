...
const Volunteer = () => {
  ...
  const validate = () => {
    ...
    else if (!/^\d{10}$/.test(formData.mobile_number)) newErrors.mobile_number = "Mobile number must be exactly 10 digits.";
  ...
  return (
    <div className="grid grid-cols-2 items-center justify-center h-screen pt-10">
      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col max-w-md pt-10 gap-2">
